...
(1, 'order-123', 'bello', 'john', 'bello@gmail.com', '11111111', '123 Main St', 'Apt 1', 'Dallas', 'TX', '75001', 'USA', 'NEW', null),
...
(1, 'CODE11', 'The Hunger Games', 34.0, 2),
(1, 'CODE12', 'To Kill a Mockingbird', 45.40, 1),
(2, 'CODE13', 'The Chronicles of Narnia', 44.50, 1)
;